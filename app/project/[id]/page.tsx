...
const projectsData: Record<string, Project> = {
  refun: {
    ...
    fullDescription:
     ...
     features: [
      "QR-based point collection system",
      "Reward catalog with redemption functionality",
      "Notifications for point milestones",
      "Real-time synchronization with Firestore",
      "User-friendly and gamified experience",
    ],
    techStack: [
      "Android (Java/Kotlin)",
      "Firebase Firestore",
    ...
    challenges: [
      "Ensuring smooth QR code scanning across devices",
      "Handling real-time synchronization",
      "Maintaining consistent reward logic",
    ],
    solutions: [
      "Integrated robust QR code libraries",
      "Optimized Firestore structure for real-time sync",
      "Designed scalable reward system",
    ],
    learnings: [
  ...
  "refun-owner": {
    ...
    title: "REFUN OWNER",
    description:
      "REFUN OWNER is the companion app for recycling partners, replacing costly vending machines by validating plastic bottles via barcode scanning and generating QR codes for users.",
    ...
    challenges: [
      "Ensuring accuracy in barcode validation",
      "Managing partner-side transaction records",
    ],
    solutions: [
      "Implemented ML Kit for reliable scanning",
      "Optimized Firestore structure for partner transactions",
    ],
    learnings: ["ML Kit integration", "Efficient Firestore data modeling"],
  },
   ...
   "sport-sense": {
    ...
    description:
      "Sport Sense is an NLP-based system that classifies sports news headlines into categories like football, basketball, or tennis using DistilBERT with 91% accuracy.",
    ...
    features: [
      "Automatic classification of sports headlines",
      "DistilBERT-based NLP model with fine-tuning",
      "91% classification accuracy",
      "Keyword-based prediction adjustment",
      "Real-time classification through Flask web app",
    ],
    techStack: [
      "Python",
      "PyTorch",
    ...
    challenges: [
      "Handling overlapping sports categories",
      "Addressing dataset imbalance",
    ],
    solutions: [
      "Added keyword-based correction layer",
  ...
  "gas-leak": {
    ...
    description:
      "An Arduino-based embedded system that detects gas leaks and fire hazards, activating alarms and an exhaust fan for mitigation while ensuring safe operation.",
    ...
    features: [
      ...
      "Low-cost, deployable safety solution",
    ],
    techStack: [
      "Arduino Uno R3",
      "MQ2 & MQ6 Gas Sensors",
    ...
    challenges: [
      "Integrating multiple sensor inputs",
      "Ensuring reliable alarm triggering",
    ],
    solutions: [
      "Developed smart control algorithms",
      "Implemented failsafe logic for fire scenarios",
    ],
    learnings: [
